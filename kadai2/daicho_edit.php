...
<body>
  <form action="daicho_update.php" method="POST">
    <fieldset>
      ...
      <div>
      お名前<br><input type="text" name="name" value="<?= $record["name"] ?>">
      </div>
      <div>
      店舗コード<br><input type="text" name="store_id" value="<?= $record["store_id"] ?>">
      </div>
      <div>
      購入商品<br><input type="text" name="goods" value="<?= $record["goods"] ?>" style="width:260px; height:330px;">
      </div>
      <div>
      EZOCAID<br><input type="text" name="ezoca" value="<?= $record["ezoca"] ?>">
      </div>      
      <div>
